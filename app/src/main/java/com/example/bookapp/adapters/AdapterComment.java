...
public class AdapterComment extends RecyclerView.Adapter<AdapterComment.HolderComment> {
    ...
    public void onBindViewHolder(@NonNull AdapterComment.HolderComment holder, int position) {
        /*---Get data from specific position of list, set data, handle clicks etc.---*/
        ...
        //format date, already function made in MyApplication class
        ...
        //we don't have user's name and profile picture, so we will load it using uid we stored in each comment
